...
import useCurrentarticle_categories from '../../../../../modules/auth/hooks/useCurrentarticle_categories'
...
function articleCategoriesListView(props) {
  ...
  const [article_categories, token, loading] = useCurrentarticle_categories()
