...
function ActionsItemView(props) {
  ...
  const handleDelete = async item => {
    if (window.confirm('Are you sure you want to delete this item?')) {
      const path = baseAPIURL + 'ticket_tags/delete'
...
function TicketTagsListView(props) {
  ...
  const columns = useMemo(() => TicketTagsColumns, [])
                ...
                <div className={`${styles.TableContainer} TableContainer`}>
                  ...
                  <table
                    ...
                    <tbody {...getTableBodyProps()}>
                      ...
                      <tr>
                        {isLoading ? (
                          <td colSpan={TicketTagsColumns.length - 1}>
                            <p>Loading...</p>
                          </td>
                        ) : (
                          <td colSpan={TicketTagsColumns.length - 1}>
...
export default TicketTagsListView
