...
const DetailedTicketThreadsView = props => {
      ...
      <div className={`${styles.CardBody} CardBody`}>
        ...
        {/* Insert all view form fields here */}
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.number}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Author Email</label>
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.author_email}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Author Name</label>
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.author_name}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Message Count</label>
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.message_count}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Subject</label>
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.subject}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Is Closed</label>
                <IMToggleSwitchComponent isChecked={originalData.is_closed} disabled />
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Is Public</label>
                <IMToggleSwitchComponent isChecked={originalData.is_public} disabled />
            </div>
...
export default DetailedTicketThreadsView
