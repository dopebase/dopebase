...
const UpdateStoryView = props => {
  ...
  const initializeModifieableNonFormData = originalData => {
    ...
    /* Insert non modifiable initialization data here */
          ...
          if (originalData.storyMediaURL) {
              nonFormData['storyMediaURL'] = originalData.storyMediaURL
          }
          
          if (originalData.storyType) {
              nonFormData['storyType'] = originalData.storyType
          }
  ...
  const saveChanges = async (modifiedData, setSubmitting) => {
    const response = await authPost(
      baseAPIURL + 'stories/update?id=' + id,
      JSON.stringify({
        ...modifiedData,
        ...modifiedNonFormData,
      }),
          ...
          <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
              ...
              <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                  ...
                  <IMStaticSelectComponent
                      ...
                      selectedOption={modifiedNonFormData.storyType}
                  />
...
export default UpdateStoryView
