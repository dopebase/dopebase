...
const DetailedNotificationsView = props => {
    ...
    const fetchData = async () => {
      try {
        const response = await authFetch(
          baseAPIURL + 'notifications/view?id=' + id,
        )
        if (response?.data) {
      ...
      <div className={`${styles.CardBody} CardBody`}>
        ...
        {/* Insert all view form fields here */}
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.body}</span>
            </div>
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Marked as Seen?</label>
                <IMToggleSwitchComponent isChecked={originalData.seen} disabled />
            </div>
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
             ...
             <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Recipient User</label>
                <IMForeignKeyComponent id={originalData.toUserID} apiRouteName="admin/social-network/users" viewRoute="../users" titleKey="email" />
            </div>
...
export default DetailedNotificationsView
