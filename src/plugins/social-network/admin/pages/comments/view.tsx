...
const DetailedCommentsView = props => {
    ...
    const fetchData = async () => {
      try {
        const response = await authFetch(
          baseAPIURL + 'comments/view?id=' + id,
        )
        if (response?.data) {
      ...
      <div className={`${styles.CardBody} CardBody`}>
        ...
        {/* Insert all view form fields here */}
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.commentText}</span>
            </div>
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
             ...
             <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <IMForeignKeyComponent id={originalData.postID} apiRouteName="admin/social-network/posts" viewRoute="../posts" titleKey="id" />
            </div>
...
export default DetailedCommentsView
