      ...
      <div className={`${styles.CardBody} CardBody`}>
        ...
        {/* Insert all view form fields here */}
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Post ID</label>
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.commentCount}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Content</label>
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.postText}</span>
            </div>
    

            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                <label className={`${styles.FormLabel} FormLabel`}>Media</label>
                {originalData.postMedia && originalData.postMedia.map((data) =>
                    <IMMultimediaComponent 
                        openable 
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.location}</span>
            </div>
            ...
            <div className={`${styles.FormFieldContainer} FormFieldContainer`}>
                ...
                <span className={`${styles.LockedFieldValue} LockedFieldValue`}>{originalData.reactionsCount}</span>
            </div>
...
export default DetailedPostsView
